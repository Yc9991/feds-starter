...
import { DxDataGrid, DxMasterDetail, DxHeaderFilter, DxPager, DxPaging, DxSearch, DxSorting, DxColumn, DxSearchPanel, DxGrouping, DxGroupPanel, type DxDataGridTypes } from 'devextreme-vue/data-grid'
        ...
        <TableDrawer v-model:layout="exampleStore.layout" :midColumnTitle="exampleStore.dataCurrent?.CompanyName">
            ...
            <template #startColumn>
                ...
                <DxDataGrid v-if="exampleStore.data" id="datagrid-example" @rowDblClick="exampleStore.rowClick"
                    ...
                    <template #CountryTemplate="{ data: rowData }">
